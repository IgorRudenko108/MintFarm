    ...
    (() => {
        ...
        class Popup {
            ...
            _openToHash() {
                ...
                document.querySelector(`[${this.options.attributeOpenButton} = "${classInHash}"]`) ? document.querySelector(`[${this.options.attributeOpenButton} = "${classInHash}"]`) : document.querySelector(`[${this.options.attributeOpenButton} = "${classInHash.replace(".", "#")}"]`);
            }
            _setHash() {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".booster__slider")) new Swiper(".booster__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (isMobile.any()) {
            ...
            if (skinBox.length > 0) for (let index = 0; index < skinBox.length; index++) {
                ...
                skinItem.addEventListener("click", (function(e) {
                    skinItem.classList.toggle("skin-open");
                }));
            }
        } else document.body.classList.add("_pc");
